...
Step 2: Access to RPi using SSH, and enable it to access internet, then update the system. Enable camera module, I2C interface, and expand filesystem to whole disk, then restart RPi. 

sudo raspi-config


Step 3: Install git, the clone this repository. 
...
Step 4: run "install.sh" to install ecorov
